...
public class UserProducer extends Twitter4JProducer {
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        if (exchange.getPattern().isOutCapable()) {
            /*
             * We want to keep the incoming message headers. "Changing the IN message directly
             * is possible in Camel as it doesn't mind. Camel will detect that the Exchange
             * has no OUT message and therefore use the IN message instead."
             *
